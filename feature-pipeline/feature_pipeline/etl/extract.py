...
def from_file(
    ...
    export_start, export_end = _compute_extraction_window(export_end_refernce_datetime=export_end_reference_datetime, days_delay=days_delay, days_export=days_export)
